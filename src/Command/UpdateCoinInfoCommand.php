...
# php bin/console app:update-coinInfo
...
class UpdateCoinInfoCommand extends Command
{
    ...
    protected static $defaultDescription = 'Atualiza os dados de CoinInfo com base no arquivo cedulas_issues.json';
    ...
    {
        $caminho = __DIR__ . '/../../public/json/moedas_issues.json';
        ...
        foreach ($dados as $item) {
            ...
            $entity = $this->em->getRepository(CoinInfo::class)
                ->findOneBy([
                    'type_id' => $typeId,
                    'issue_id' => $issueId
                ]);
